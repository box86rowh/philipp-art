...
urlpatterns = patterns('',
                       ...
                       url(r'^pieces/(?P<id>\w+)/add-document', 'art_database.views.add_document_to_piece', name='add_document_to_piece'),
                       url(r'^pieces/(?P<piece_id>\w+)/photo/(?P<photo_id>\w+)/delete', 'art_database.views.delete_photo', name='delete_photo'),
                       url(r'^pieces/(?P<piece_id>\w+)/document/(?P<document_id>\w+)/delete', 'art_database.views.delete_document', name='delete_document'),
                       ...
                       url(r'^art-list/export-documents', 'art_database.views.export_documents', name='export_documents'),
